...
const Projects = () => {
  return (
    ...
    //   </div>
    // </div>
    <div className="min-h-[60vh] max-h-[90vh] overflow-hidden flex flex-col justify-center items-start md:items-center">
      <div className="flex justify-center items-center">
        <h2>Projects</h2>
      </div>
      <div className="p-8 h-full w-full flex flex-row justify-center items-center flex-wrap gap-8">
